const socialLinks = [
  {
    href: "https://www.github.com/mahaabi01",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/mahaabi01",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.instagram.com/mahaabi001",
    icon: (
      <svg
        width="25"
        height="24"
    ...
    >
      <div className="container lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-1 lg:max-w-[12ch] reveal-up">Contact me for collaboration</h2>
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            React out today to discuss your project needs and start
        ...
        <form 
        action="https://getform.io/f/aollxqxb" 
        method="POST" 
